...
{
    [DbContext(typeof(MyCollegeV1DbContext))]
    [Migration("20240209113210_AddCollegeIdForeignKeyInStudent")]
    partial class AddCollegeIdForeignKeyInStudent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCollegeV1.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MyCollegeV1.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("MyCollegeV1.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("MyCollegeV1.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("MyCollegeV1.Authorization.Roles.Role", b =>
                {
                    ...
                    b.HasOne("MyCollegeV1.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("MyCollegeV1.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
